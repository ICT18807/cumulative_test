package com.cumulative_test.cumulative_test.utilities;
...
public class WebDriverManager {
    ...
    public synchronized static WebDriver initializeDriver() {
        ...
        if (browserName.equals("Chrome")) {
            ...
            //Update page load time according to the browser
            EnvironmentConstants.PAGE_LOAD_TIMEOUT = 20;
            ...
            //Update page load time according to the browser
            EnvironmentConstants.PAGE_LOAD_TIMEOUT = 30;
